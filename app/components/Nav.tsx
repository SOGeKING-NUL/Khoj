...
export default function Nav(){
  ...
  return(
    <nav className="flex w-full justify-between items-center px-6 py-4 border-b border-border">
        <Link href='/' className="text-xl font-bold text-foreground">Khoj</Link>
